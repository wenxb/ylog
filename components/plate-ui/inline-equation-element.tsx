...
import {useEditorSelector, useElement, useSelected} from "@udecode/plate/react"
...
export const InlineEquationElement = withRef<typeof PlateElement>(({children, className, ...props}, ref) => {
    ...
    return (
        <PlateElement
            ref={ref}
            className={cn("inline-block rounded-sm select-none [&_.katex-display]:my-0", className)}
            {...props}
        >
