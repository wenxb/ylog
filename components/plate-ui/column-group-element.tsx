        ...
        <Popover open={isOpen} modal={false}>
            ...
            >
                <div className="box-content flex items-center [&_svg]:size-4 [&_svg]:text-muted-foreground">
                    <Button size="icon" variant="ghost" onClick={() => onColumnChange(["50%", "50%"])}>
                        <DoubleColumnOutlined />
                    </Button>
                    <Button size="icon" variant="ghost" onClick={() => onColumnChange(["33%", "33%", "33%"])}>
                        <ThreeColumnOutlined />
                    </Button>
                    <Button size="icon" variant="ghost" onClick={() => onColumnChange(["70%", "30%"])}>
                        <RightSideDoubleColumnOutlined />
                    </Button>
                    <Button size="icon" variant="ghost" onClick={() => onColumnChange(["30%", "70%"])}>
                        <LeftSideDoubleColumnOutlined />
                    </Button>
                    <Button size="icon" variant="ghost" onClick={() => onColumnChange(["25%", "50%", "25%"])}>
