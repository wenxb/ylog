...
export const CodeBlockElement = withRef<typeof PlateElement>(({children, className, ...props}, ref) => {
    ...
    return (
        <PlateElement ref={ref} className={cn(className, "py-1", state.className)} {...props}>
...
export function CodeBlockFormatButton({editor, element}: {editor: Editor; element: TElement}) {
