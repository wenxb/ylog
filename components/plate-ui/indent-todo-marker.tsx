...
export const TodoMarker = ({element}: Omit<SlateRenderElementProps, "children">) => {
    ...
    return (
        <div contentEditable={false}>
            <Checkbox className={cn("absolute top-1 -left-6", readOnly && "pointer-events-none")} {...checkboxProps} />
        </div>
    )
}
...
export const TodoLi = (props: SlateRenderElementProps) => {
    ...
    return (
        <li className={cn("list-none", (element.checked as boolean) && "text-muted-foreground line-through")}>
            {children}
        </li>
    )
}
