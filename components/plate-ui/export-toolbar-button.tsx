...
import {BaseParagraphPlugin, createSlateEditor, serializeHtml, SlateLeaf} from "@udecode/plate"
...
export const markdownToPlate = (text: string)=>{
    ...
    return editorStatic.getApi(MarkdownPlugin).markdown.deserialize(text);
}
...
export function ExportToolbarButton({children, ...props}: DropdownMenuProps) {
    ...
    const exportToHtml = async () => {
        const body = await plateToHtml(editor.children)
