...
import {useComboboxInput, type UseComboboxInputResult, useHTMLInputCursorState} from "@udecode/plate-combobox/react"
...
const InlineComboboxContent: typeof ComboboxPopover = ({className, ...props}) => {
    ...
    return (
        <Portal>
            <ComboboxPopover
                className={cn(
                    "z-[500] max-h-[288px] w-[300px] overflow-y-auto rounded-lg border bg-popover shadow-lg",
                    className
                )}
                {...props}
            />
