...
export const PlayArrowFill = ({className}) => (
    <svg
        className={cn("yw-icon", className)}
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
        viewBox="0 -960 960 960"
        width="24px"
...
export const MusicNoteFill = ({className}) => (
    <svg
        className={cn("yw-icon", className)}
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
...
export const ProgressActivity = ({isActive, className}) => (
    <svg
        className={cn("yw-icon", isActive && "animate-spin", className)}
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
        viewBox="0 -960 960 960"
        width="24px"
